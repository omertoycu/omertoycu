...
Kocaeli Üniversitesi **Bilgisayar Mühendisliği** mezunuyum. Ham veriyi akıllı içgörülere dönüştüren **yapay zeka modelleri** geliştiriyor ve bu modelleri uçtan uca çalışan **ölçeklenebilir yazılım mimarilerine** entegre ediyorum.

- 🤖 &nbsp;**NLP**, **Bilgisayarlı Görü** ve **Derin Öğrenme** alanlarında modeller tasarlıyor, eğitiyor ve optimize ediyorum.
- ⚙️ &nbsp;AI modellerini production'a taşımak için **FastAPI** ile yüksek performanslı API'ler ve sağlam veri hatları kuruyorum.
- 🧬 &nbsp;**C/C++** ile düşük seviyeli otonom yapılar ve sistem yazılımları geliştiriyorum.
- 🔭 &nbsp;Şu an **Büyük Dil Modelleri (LLM)**, **RAG**, **semantik vektör aramaları** ve **otonom sistemler** üzerine çalışıyorum.
...
| **Framework** | ![FastAPI](https://img.shields.io/badge/FastAPI-009688?style=flat-square&logo=fastapi&logoColor=white) ![Jupyter](https://img.shields.io/badge/Jupyter-F37626?style=flat-square&logo=jupyter&logoColor=white) ![Selenium](https://img.shields.io/badge/Selenium-43B02A?style=flat-square&logo=selenium&logoColor=white) |
| **Veri & DB** | ![MongoDB](https://img.shields.io/badge/MongoDB-47A248?style=flat-square&logo=mongodb&logoColor=white) ![Pandas](https://img.shields.io/badge/Pandas-150458?style=flat-square&logo=pandas&logoColor=white) ![NumPy](https://img.shields.io/badge/NumPy-013243?style=flat-square&logo=numpy&logoColor=white) |
| **Araçlar** | ![Git](https://img.shields.io/badge/Git-F05032?style=flat-square&logo=git&logoColor=white) ![Postman](https://img.shields.io/badge/Postman-FF6C37?style=flat-square&logo=postman&logoColor=white) ![Linux](https://img.shields.io/badge/Linux-FCC624?style=flat-square&logo=linux&logoColor=black) |
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><a href="https://github.com/omertoycu/WebHaberTakip"><b>WebHaberTakip</b></a></td>
      <td><code>Python</code> <code>FastAPI</code> <code>NLP</code> <code>BERT</code></td>
      <td>Kentsel olayları web scraping ile toplayan, <b>BERT tabanlı embedding</b> modelleriyle sınıflandıran ve harita üzerinde görselleştiren uçtan uca akıllı sistem.</td>
    </tr>
    <tr>
      <td align="center">🖼️</td>
      <td><a href="https://github.com/omertoycu/image-captioning-project"><b>Image Captioning</b></a></td>
      <td><code>Deep Learning</code> <code>CNN</code> <code>RNN</code></td>
      <td><b>Computer Vision</b> ve <b>NLP</b>'yi birleştirerek görselleri analiz eden ve otomatik metinsel açıklamalar üreten derin öğrenme modeli.</td>
    </tr>
    <tr>
      <td align="center">🎬</td>
    ...
    <tr>
      <td align="center">🏥</td>
      <td><a href="https://github.com/omertoycu/HastaneAi"><b>HastaneAi</b></a></td>
      <td><code>Python</code> <code>Data Science</code></td>
      <td>Sağlık verileri üzerinden <b>tahminleme</b> yapan ve hastane süreçlerini optimize etmeyi hedefleyen yapay zeka tabanlı analiz sistemi.</td>
    </tr>
  </tbody>
</table>
...
<div align="center">
  ...
  **💬 Yapay zeka, veri bilimi veya yazılım üzerine konuşmak ister misiniz?**
  ...
  <a href="https://www.linkedin.com/in/%C3%B6mer-toycu-251bb3293/">
    <img src="https://img.shields.io/badge/Bana_Ulaşın-58A6FF?style=for-the-badge&logo=handshake&logoColor=white" />
  </a>
